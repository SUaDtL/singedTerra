...
- [x] Correct Commander mobility and fuel composition: center the A/left/right/D controls, remove the leftward drift and dead space, and prevent the 100/FUEL readout from overlapping its gauge ring.  (from user screenshot codex-clipboard-228b3cbf-656f-48cc-b994-e84aa3980a01.png)  (done 2026-09-07)
