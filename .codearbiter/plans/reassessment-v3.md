...
| T03 → T04 | T03: 2,155 client tests and coverage pass; browser proof caught retry below the viewport, now corrected with three desktop browser tests passing. Compact checks and independent review pending. T04 follows serially. | Sol/high; Astra review |
...
| T06 | PR #502: `90bc3cd` rebases reviewed `a4d961d` without content changes; 2,136 client tests, coverage, independent review and actual browser equip/fire proof passed. CI pending. | Terra/medium; Sol review |
| T07 | PR #502 head `ab193c072c0f23a4e94423153ad6edcb4019a7d8`; independent review and root browser proof pass, 2,138 client tests and typecheck pass. Physical mouse/touch verification remains pending. | Terra/medium; Sol review |
...
| T09 | Confirmed visual defect: impact monitor, explosion and damage cue are covered by the full report within the next 100 ms sampled frame, normal and reduced motion. Fix queued behind T08; physical phone evidence pending. | Terra/high; Sol review |
| T10 | Committed locally as `3cd87b93d6c10790995c16faf099f070ebfe5c2d`; independent review, normal/negative controls and full engine check pass. Path B unchanged. Not yet published. | Terra/medium; Sol review |
