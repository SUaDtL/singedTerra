...
| R24 | AC-076, AC-077, AC-078 | R00 | gpt-5.6-terra / high | gpt-6-astra / high | APPROVED_PENDING_INTEGRATION |
...
Integration: C:/Users/brenn/projects/singedTerra-worktrees/evidence-recovery-v2, branch codex/evidence-recovery-v2; source baseline 3902cad662aea03cec913d984d17aa9573b89bd0. Parent alone owns this ledger, integration, commits, and the sole localhost. Task worktrees below share the audit baseline; all task changes remain uncommitted until the parent commit gate clears. No production or remote-setting action has occurred.
...
| R24 | Worktree ../recovery-v2-r24, branch codex/recovery-v2-r24. Frozen four-file fix and receipt; fresh final Astra/high review, triage, aggregate PASS AC-076..078 with zero findings. Parent final focused suite 53/53 exit 0. Preserved exact D09 plus actual operation-selected opening/escalated/reset guide versus live projectile regression. Earlier unchanged-production coverage: Windows lines 93.14% (8107/8704), branches 81.5% (4764/5845), 200 files/1778 tests, exit 0; ../recovery-v2-r24-coverage.log. Typecheck/build passed. Main integration waits for R25 shared-file release. Live browser/Supabase/verified replay is not claimed by route mocks. |
...
| R25 | Worktree ../recovery-v2-r25, branch codex/recovery-v2-r25. Sol/high implementation holds its exclusive write lease. Meaningful red reported before production edits. Parent owns browser/server coordination. |
| R13 | Worktree ../recovery-v2-r13, branch codex/recovery-v2-r13. Terra/high implementation has uncommitted checker, test, and CI changes; lease temporarily released for this parent documentation commit. No final verification/review yet. CI edits serialize before R04. |

Exclusive task paths:
- R24: client/src/main.ts, renderer/aimGuidePresentation.ts and its test, main.hotSeatProgression.test.ts. No active writer; do not integrate overlapping paths while R25 writes.
- R21 current diff: shared/src/engine/AI.ts, scripts/checks/ai.mjs, client/src/client/NetworkClient.ts and NetworkClient.botRetry.test.ts. Necessary preparation recovery in main.ts and main.hotSeatProgression.test.ts will serialize after R25. No active writer.
