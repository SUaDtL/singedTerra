...
- [x] Run adversarial review, exact-head CI, merge, Pages deployment, scoped Edge deployment, and production geometry proof.

**Verification:** `npx playwright test e2e/hud-layout.spec.ts e2e/online-garage-layout.spec.ts`
**Maps to:** O-08 real-browser usability and layering
**Status:** ACCEPTED — PR #416 merged as `main@a237fb64376e213234110509ca1db6b97dfd3fc2`; exact-main CI, CodeQL, Pages, the scoped verifier-probe deployment, and the bounded live geometry proof are recorded. `career.initiative.0001` remains active for the next player-facing outcome.
