...
| T38 | IN-PROGRESS | Run the full native visual matrix on the sole existing `127.0.0.1:4173` listener, refresh evidence, complete fresh non-Astra review and verification, commit through the gate, and update draft PR #515 without merge or deployment. | correction files; `.codearbiter/evidence/command-center-workspace-finish/**`; sprint log; PR metadata | Local, Verified, and Online are directly reviewed at standard, 2272-class, and ultrawide geometry plus existing compact/portrait states; focused/full suites and hosted CI are green at the exact PR head; no second game listener exists. | `AC-34` through `AC-38` obligations | `AC-34`, `AC-35`, `AC-36`, `AC-37`, `AC-38` | T35, T36, T37 |
